...
![Harmony Ecosystem](../.gitbook/assets/ecosystem_20.6.2021%20copy%20%281%29.png)
...
| :--- | :--- | :--- |
| Wallets | [Magic](https://magic.link/), [sprout](https://sprout.sesameseed.org/) | - social recovery & one-time-password authenticators for on-chain fund - basic income & wealth from fixed-rate or high-yield investments   - User-friendly Wallet based on  open millions to self-custody assets & collectibles without hardware, password or hack  - [Composable Authentication](https://github.com/hashmesan/harmony-totp)  - [Social onchain recovery](https://vitalik.ca/general/2021/01/11/recovery.html)  - [EIP-2938 Account abstraction implementation](https://github.com/harmony-one/bounties/issues/35)  - [on-device privacy](https://medium.com/@ronaldmannak/vivo-pay-a-zero-knowledge-payment-system-727997e4d25f)  - Keyless Security  - web3 integrations  - [Harmony Argent Integration](https://github.com/harmony-one/bounties/issues/31) |

...
Vvisit your playground using the URL [http://127.0.0.1:8030/graphql/playground](http://127.0.0.1:8030/graphql/playground) and start playing around with graphQL API.

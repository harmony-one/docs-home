...
Staking via browser is done via [Staking Dashboard](https://staking.harmony.one/). There you will be able to delegate, undelegate tokens, claim rewards and manage your delegations. Currently, staking transaction are supported on [Ledger Nano S,](../../../../general/ecosystem/wallets/hardware-wallets/ledger/) [ONE Wallet](../../../../general/ecosystem/wallets/browser-extensions-wallets/one-wallet.md) and [Math Wallet](../../../../developers/web3-foundations/wallets/mathwallet.md). you can log in or create a new address via those three wallets.

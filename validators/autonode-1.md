...
{% tabs %}
{% tab title="Ubuntu" %}
You will be logged on as root on your system and need to create a user to work with your auto\_node. _**You can choose any username you want**_, for example we use **autonode** here, it will ask for a password and a password confirmation. Please keep track of this password for future use!
